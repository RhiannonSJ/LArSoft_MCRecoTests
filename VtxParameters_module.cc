...
void recotests::VtxParameters::endJob()
{
  ...
  TFile *f = new TFile( "/sbnd/app/users/rsjones/LArSoft_v06_55_00/LArSoft-v06_55_00/srcs/recoperformance/recoperformance/SBN_Workshop/primary_metrics/primary_vtx_metrics.root", "RECREATE" );
