...
rm -rf /sbnd/app/users/rsjones/LArSoft_v06_52_00/LArSoft-v06_52_00/srcs/recoperformance/recoperformance/SBN_Workshop/pg_proton_plots/sbn_pg_proton_nt.root

cd $WORKING_DIR

lar -c run_particleGun.fcl -S $TEST_SBN_PROTON
